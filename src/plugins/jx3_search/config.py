...
class JX3PROFESSION(Enum):
    '''剑网三心法枚举'''
    无方 = {"无方", "药宗", "药宗输出", "药宗dps", "北天药宗"}
    灵素 = {"灵素", "药奶", "奶药", "药宗奶妈"}
    太玄经 = {"太玄经", "衍天宗", "衍天", "太玄"}
    隐龙诀 = {"隐龙诀", "隐龙", "凌雪阁", "凌雪", "野猪"}
    凌海诀 = {"凌海诀", "凌海", "蓬莱", "伞爹", }
    ...
    惊羽诀 = {"惊羽诀", "惊羽", "鲸鱼", "娃娃鱼", "弩箭", "唐门"}
    天罗诡道 = {"天罗诡道", "田螺", "天罗", "螺", "机关"}
    毒经 = {"毒经", "读经", "五毒dps", "五毒输出", "五毒"}
    补天诀 = {"补天诀", "补天", "奶毒", "毒奶", "补天决"}
    山居剑意 = {"山居剑意", "问水诀", "藏剑", "黄鸡", "山居", "问水", "鸡哥", "风车侠"}
    傲血战意 = {"傲血战意", "傲雪", "傲血", "天策dps", "天策输出", "天策", "哈士奇", "狗策"}
    铁牢律 = {"铁牢律", "铁牢", "策T", "策t", "天策T", "天策t", "狗t", "狗T"}
    太虚剑意 = {"太虚剑意", "太虚", "剑纯", "渣男"}
    紫霞功 = {"紫霞功", "紫霞", "气纯"}
    ...
    云裳心经 = {"云裳心经", "云裳", "秀奶", "奶秀"}
    花间游 = {"花间游", "花间", "万花dps", "万花输出", "万花", "花花", "花间T", "花间琉璃体"}
    离经易道 = {"离经易道", "离经", "奶花", "花奶"}
